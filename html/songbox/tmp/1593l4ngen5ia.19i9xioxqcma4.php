               ...
               <div class="container-fluid mt-4">
                  ...
                  <div class="row">
                     <div class="col-lg-7 mb-4">
                        ...
                        <textarea class="bg-transparent m-0 form-control border-0 text-gray-900" onfocus="if(this.value == 'Write down your idea here...') {this.value=''}" name="textarea" rows="10" id="textarea"><?= $hereThisRecord['textarea'] ?></textarea>
                     ...
                     <!--    <select name="tag" id="tag">
                        ...
                        <p class="mb-0 ml-auto text-center">
                           ...
                           <!-- <textarea class=" border-0 text-gray-900" name="textarea" onfocus="if(this.value == 'Write down your idea here...') {this.value=''}" rows="5" cols="50" id="textarea"><?= $hereThisRecord['textarea'] ?></textarea>
                           ...
                           <!-- inserting php code - f3 framework, brackets + tilda. -->
                           <!-- </p>
                           <p>
                           <input type="hidden" name="toEdit" value="<?= $hereThisRecord['id'] ?>">
