               ...
               <div class="row">
                  <div class="col-lg-7 mb-4">
                     ...
                     <div class="card shadow">
                        ...
                        <input type="radio" name="tag" value="Rock" id="Rock" checked = 'checked'}><label for="Rock">Rock</label>
                        <input type="radio" name="tag" value="Blues" id="Blues" ><label for="Blues">Blues</label>
                        <input type="radio" name="tag" value="Pop" id="Pop" ><label for="Pop">Pop</label>

                        </p>
                        <p class="mb-0 ml-auto text-center">
                        <input class="btn bg-gradient-primary submit-button" type="submit" name="Submit" value="Submit" id="submitButton" />
                        </p>
                        </form>                                                                     <!-- end form -->
                        </div>
                     </div>
